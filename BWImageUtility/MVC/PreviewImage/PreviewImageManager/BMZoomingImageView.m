...
@interface BMZoomingImageView () <UIScrollViewDelegate>
...
@implementation BMZoomingImageView
...
- (void)resetZoomScale {
    ...
    _scrollView.maximumZoomScale = 2.0;  // scale in portrait
}
